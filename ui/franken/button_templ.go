...
func Button(data ButtonData) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if data.Link != "" {
			...
			var templ_7745c5c3_Var3 templ.SafeURL = templ.URL(data.Link)
			...
			var templ_7745c5c3_Var4 = []any{templ.Classes("uk-button", fmt.Sprint("uk-button-"+data.Color), data.Class)}
			...
			templ_7745c5c3_Var5, templ_7745c5c3_Err = templ.JoinStringErrs(string(data.Type))
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `ui/franken/button.templ`, Line: 75, Col: 63}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `ui/franken/button.templ`, Line: 75, Col: 163}
			}
			...
			var templ_7745c5c3_Var8 = []any{templ.Classes("uk-button", fmt.Sprint("uk-button-"+data.Color), data.Class)}
			...
			templ_7745c5c3_Var9, templ_7745c5c3_Err = templ.JoinStringErrs(string(data.Type))
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `ui/franken/button.templ`, Line: 78, Col: 62}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `ui/franken/button.templ`, Line: 78, Col: 162}
			}
